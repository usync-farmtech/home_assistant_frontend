...
const HOME_ASSISTANT_CORE_TITLE = "Usync Assistant Core";
const HOME_ASSISTANT_SUPERVISOR_TITLE = "Usync Assistant Supervisor";
const HOME_ASSISTANT_OS_TITLE = "Usync Assistant Operating System";
