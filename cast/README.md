# Usync Assistant Cast

Usync Assistant Cast is made up of two separate applications:

- Chromecast receiver application that can connect to Usync Assistant and display relevant information.
- Launcher website that allows users to authorize with their Usync Assistant installation and launch the receiver app on their Chromecast.
...
If your work involves interaction with the Cast parts from the normal Usync Assistant UI, you will need to have that development script running too (`script/develop`).

### Developing the cast demo

The cast demo is triggered from the Usync Assistant demo. To work on that, you will also need to run the development script for the demo (`script/develop_demo`).
