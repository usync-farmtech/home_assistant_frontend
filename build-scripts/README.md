# Bundling Usync Assistant Frontend

The Usync Assistant build pipeline contains various steps to prepare a build.
...
Currently in Usync Assistant we use a bundler to convert TypeScript, CSS and JSON files to JavaScript files that the browser understands.
